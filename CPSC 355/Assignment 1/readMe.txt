...
The swap method gets two parameters(a,b). It assigns (b) to a temporary variable (c), and (b) is assigned as (a), (so b = a). Now (a) is assigned to (c) (a = c) where (c) kept (b)'s previous value.
